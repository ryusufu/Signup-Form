...
},{"./..\\images\\icon-error.svg":[["icon-error.7540ea9a.svg","images/icon-error.svg"],"images/icon-error.svg"],"./..\\images\\bg-intro-desktop.png":[["bg-intro-desktop.62667658.png","images/bg-intro-desktop.png"],"images/bg-intro-desktop.png"],"./..\\images\\bg-intro-mobile.png":[["bg-intro-mobile.6030d29e.png","images/bg-intro-mobile.png"],"images/bg-intro-mobile.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"scripts/main.js":[function(require,module,exports) {
"use strict";
...
form.addEventListener("input", function (e) {
  if (e.target === firstName || e.target === lastName || e.target === password) {
